...
public class MusicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //animes = new ArrayList<String>(Arrays.asList(getResources().getStringArray(R.array.animes)));//lista de animes
        //musics = new ArrayList<String>(Arrays.asList(getResources().getStringArray(R.array.animes)));//lista de animes
        //images = new ArrayList<String>(Arrays.asList(getResources().getStringArray(R.array.animes)));//lista de animes
        ...
        try{
            //mp3.setDataSource("https://api-2.datmusic.xyz/links/6d891599686e216eb28a66c84b81d55d/Noragami%20Aragoto%20-%20Official%20Opening%20-%20Kyouran%20Hey%20Kids.mp3");
            //mp3.setDataSource("https://api-2.datmusic.xyz/links/268e6efa393c1d347c1e0ae63d109ec4/Nightcore%20-%20I%20Like%20It%20Loud%20Cash%20Cash%20Cover.mp3");
    ...
    public void submit(View view) {
        ...
        //songName.setText("Now Playing : ");//+animes[index]);
